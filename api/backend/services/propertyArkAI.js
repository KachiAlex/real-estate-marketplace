...
/**
 * PropertyArk AI service replicated from frontend implementation.
 * Provides intent detection and contextual responses for the AI assistant.
 */
class PropertyArkAI {
  constructor() {
    this.context = {
  ...
  setContext(context) {
    ...
    if (Array.isArray(this.context.conversationHistory)) {
  ...
  extractEntities(message) {
    ...
    if (bathroomMatch) {
      entities.bathrooms = parseInt(bathroomMatch[1], 10);
    }
