...
const resolveApiBaseUrl = (preferredBase) => normalizeBaseUrl(preferredBase || DEFAULT_API_BASE_URL);

const buildApiUrl = (path = '', preferredBase) => {
  const base = resolveApiBaseUrl(preferredBase);
