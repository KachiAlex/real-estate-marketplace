...
const ProtectedRoute = ({ children, requiredRoles = null }) => {
  ...
  if (loading) {
    return <SplashScreen label="Preparing your dashboard…" />;
  }
  ...
  const buyerPrefixes = ['/dashboard', '/buyer', '/my-inquiries', '/my-inspections', '/my-properties', '/saved-properties', '/alerts'];
  ...
  // Block admin from accessing buyer or vendor routes — admin must use /admin only
