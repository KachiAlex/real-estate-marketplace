...
const RegisterModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center" role="dialog" aria-modal="true" aria-label="Register" onClick={onClose}>
      ...
      >
        <button onClick={onClose} aria-label="Close register modal" className="absolute right-3 top-3 text-gray-700 dark:text-gray-200 text-2xl sm:text-3xl">✕</button>
