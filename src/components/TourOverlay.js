...
const TourOverlay = () => {
  ...
  useEffect(() => {
    if (isTourActive && currentStep && currentStep.id === 'welcome') {
      ...
      const welcomeMessage = "Hello! I'm your PropertyArk AI assistant. Would you like me to give you a guided tour of our amazing real estate platform? I can show you all the wonderful features we have to offer. Just say 'yes' to start the tour, or 'no' to skip it.";
      setTimeout(() => {
