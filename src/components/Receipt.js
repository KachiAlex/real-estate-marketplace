...
const Receipt = ({ transaction, onClose }) => {
  ...
  const downloadReceipt = () => {
    ...
    try {
      ...
      toast.error('Receipt preview could not be opened in this environment.');
      return;
    }

    if (!printWindow) {
      toast.error('Receipt popup was blocked. Please allow popups or use a desktop browser.');
      return;
    }
    ...
    try {
      ...
      toast.error('Receipt preview could not be rendered.');
      return;
    }
