          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-gray-900 text-sm sm:text-base truncate ml-2">{formatCurrency(itemPrice)}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600 text-sm sm:text-base">Escrow Protection Fee (0.5%)</span>
                <span className="font-semibold text-gray-900 text-sm sm:text-base truncate ml-2">{formatCurrency(escrowFee)}</span>
              </div>
              <div className="border-t border-gray-200 pt-3 flex items-center justify-between">
                <span className="text-base sm:text-lg font-semibold text-gray-900">Total Due Today</span>
                <span className="text-xl sm:text-2xl font-bold text-blue-600 truncate ml-2">{formatCurrency(totalDue)}</span>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow p-6 space-y-4">
            ...
            <div className="flex justify-between gap-2">
              ...
              <span className="font-semibold text-gray-900 text-sm sm:text-base truncate">{formatCurrency(itemPrice)}</span>
            </div>
            <div className="flex justify-between gap-2">
              <span className="text-gray-600 text-sm sm:text-base">Escrow Fee</span>
              <span className="font-semibold text-gray-900 text-sm sm:text-base truncate">{formatCurrency(escrowFee)}</span>
            </div>
            <div className="border-t border-gray-200 pt-4 flex justify-between items-center gap-2">
              <span className="text-base sm:text-lg font-semibold text-gray-900">Total</span>
              <span className="text-lg sm:text-2xl font-bold text-blue-600 truncate">{formatCurrency(totalDue)}</span>
            </div>
          </div>
        </div>
      )}
