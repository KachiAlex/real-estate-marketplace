...
const AutoTourPopup = () => {
  ...
  const speakWelcomeMessage = () => {
    try {
      ...
      const welcomeText = "Welcome toPropertyArk! I'm yourPropertyArkAI assistant. I'm so excited to meet you! I'd love to give you a comprehensive tour of our amazing platform. Would you like me to show you around?";
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md mx-auto p-6 relative">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600">
            I'm yourPropertyArkAI assistant! I'm so excited to meet you and show you around our amazing platform.
          </p>
        </div>
