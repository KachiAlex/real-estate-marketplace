                ...
                <div className="bg-blue-50 p-4 rounded-lg flex flex-col gap-3">
                  ...
                  <div className="bg-white rounded-lg p-4 flex flex-col gap-2 border border-blue-100">
                    <div className="flex items-center justify-between gap-2">
                      <span className="font-medium text-sm sm:text-base">Verification Fee:</span>
                      <span className="text-lg sm:text-2xl font-bold text-green-600 truncate">{formatCurrency(verificationFee)}</span>
                    </div>
