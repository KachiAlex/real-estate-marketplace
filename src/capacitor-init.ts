 ...
 */
async function configureSafeArea(): Promise<void> {
  try {
 ...
 */
function configureCookiesPlugin(): void {
  try {
 ...
 */
export function setupCapacitorErrorHandler(): void {
 ...
 */
function logCapacitorError(error: any): void {
  // Log to console
