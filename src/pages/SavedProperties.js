...
const SavedProperties = () => {
    ...
    try {
      ...
      const transformProperty = (property, favoriteId) => {
        return {
          ...
          image: property.coverImage || property.featuredImage || property.image || property.images?.[0]?.url || property.images?.[0] || 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=400&h=300&fit=crop',
  ...
  const createInquiry = (property, inquiryType, message = '') => {
    ...
    const inquiry = {
      ...
      propertyImage: property.coverImage || property.featuredImage || property.image || property.images?.[0]?.url || property.images?.[0] || '',
