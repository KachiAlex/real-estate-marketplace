...
const AdminDashboard = () => {
  ...
  const contentWidthClasses = activeTab === 'properties'
    ? 'w-full max-w-[92rem] mx-auto px-4 sm:px-6 lg:px-10 xl:px-16'
    : 'w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-10 xl:px-16';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="verified">Approved for Listing</option>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="sticky right-0 z-10 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50 shadow-[-8px_0_8px_-8px_rgba(0,0,0,0.15)]">
                        Actions
                      </th>
                    </tr>
                  </thead>
                  <tbody className="bg-white divide-y divide-gray-200">
                    {properties.map((property) => (
                      <tr key={property.id}>
                        ...
                        <td className="sticky right-0 z-10 px-6 py-4 whitespace-nowrap text-sm font-medium bg-white shadow-[-8px_0_8px_-8px_rgba(0,0,0,0.15)]">
                          <button
