...
const Dashboard = () => {
  ...
  // Refresh user data on route changes to prevent stale data
            ...
            {(recentProperties.length > 0 ? recentProperties : mockProperties).map((property) => (
              <div key={property.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <div className="relative">
                  ...
                  >
                  <img
                    src={property.coverImage || property.featuredImage || property.image || property.images?.[0]?.url || 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=400&h=300&fit=crop'}
                    alt={property.title}
                ...
                >
                  ...
                  <h3 className="font-semibold text-gray-900 mb-1 break-words overflow-wrap-anywhere">{property.title}</h3>
