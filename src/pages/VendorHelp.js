...
// Support tickets removed — contact via support@propertyark.com
...
const VendorHelp = () => {
  ...
  // Support tickets removed; vendors should email support@propertyark.com
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "When a buyer makes a purchase, funds are held in our secure escrow account for 14 days. The buyer can confirm property possession or file a dispute. If no action is taken within 14 days, the transaction requires admin review before funds are released. This protects both parties."
    },
    {
      id: 4,
    ...
    <div className="p-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
        <div className="mb-4">
          ...
          <p className="text-gray-600">We no longer support in-app support tickets. Please email our support team with your account email, a short description of the issue, and any relevant attachments.</p>
          <p className="mt-3 font-medium text-brand-blue"><a href="mailto:support@propertyark.com">support@propertyark.com</a></p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg border border-gray-200 p-6 text-center">
          ...
          <p className="text-brand-blue font-semibold">support@propertyark.com</p>
          ...
          <p className="text-gray-600 mb-4">In-app tickets are deprecated. Please email support@propertyark.com with details and we will respond by email.</p>
